...
$(document).ready(function () {
  readTextFile("./assets/json/jobs-en.json", function(text){
      ...
      $.each(jobs, function(i){
        ...
        job_html += '<a target="_blank" href="'+ job["link"] +'" class="image fit"><img src="'+ job["img"] +'" alt="'+ job["enterprise"] +'" /></a>';
        ...
        job_html += '<a class="info" target="_blank" href="'+ job["link"] +'"><i class="fa fa-info-circle" aria-hidden="true"></i>'+"To know more</a>";
  ...
  readTextFile("./assets/json/studies-en.json", function(text){
      ...
      $.each(grads, function(i){
        ...
        if(grad["link"]){
            grad_html += '<a target="_blank" href="'+ grad["link"] +'" class="image fit"><img src="'+ grad["img"] +'" alt="'+ grad["school"] +'" /></a>';
        }else{
            grad_html += '<div class="empty-img"></div>';
        }
        ...
        if(grad["link"]){
            grad_html += '<a class="info" target="_blank" href="'+ grad["link"] +'"><i class="fa fa-info-circle" aria-hidden="true"></i>'+"To know more</a>";
        }
        grad_html += '</div>';
  ...
  readTextFile("./assets/json/skills-en.json", function(text){
    ...
    $.each(skills, function(i){
      ...
      $.each(skill["skills"], function(i, k){
        skill_html += '<li><span>'+ k['name'];
        skill_html += '</span><div class="progress"><div class="progress-meter" style="width: '+k['level']+'%"></div></div></li>';
        skill_html += '</li>';
      })
      skill_html += '</ul></div>';
  ...
  readTextFile("./assets/json/contact.json", function(text){
      ...
      $.each(contacts, function(i){
        contact = contacts[i];
        contact_html = "<li>";
        contact_html += '<a target="_blank" href="'+ contact["link"] +'"><i class="fa ' + contact["picto"] + '"></i><span class="hide-for-small-only">'+ contact["name"] +'</span></a>';
        contact_html += '</li>';
